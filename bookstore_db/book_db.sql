...
INSERT INTO `address` VALUES (1,'123 Elm St','New York','7008',1),(2,'456 Maple Rd','London','E17DB',2),(3,'789 Oak Ave','Toronto','M4C',3),(4,'165 Vilakazi','1808','Johannesburg',4);
...
INSERT INTO `author` VALUES (1,'J.K.','Rowling'),(2,'George R.R.','Martin'),(3,'Robert C.','Martin'),(4,'Sylvia','Plath'),(5,'Zadie','Smith');
...
INSERT INTO `book` VALUES (1,'Harry Potter','9780439708180',1997,150.00,1,1),(2,'A Game of Thrones','9780553103540',1996,200.00,1,4),(3,'Clean Code','9780132350884',2008,210.00,2,3),(4,'Neverwhere','9780060557812',1996,100.00,3,1);
...
INSERT INTO `book_language` VALUES (1,'English'),(2,'Spanish'),(3,'French'),(4,'Swahili'),(5,'Yoruba'),(6,'Zulu'),(7,'Sotho');
...
INSERT INTO `country` VALUES (1,'USA'),(2,'UK'),(3,'Canada'),(4,'South Africa');
...
INSERT INTO `cust_order` VALUES (1,1,'2025-04-12',2,1000.00,1),(2,2,'2025-04-11',1,2000.00,2),(3,3,'2025-03-04',3,4000.00,3),(4,4,'2025-03-16',3,4000.00,3);
...
INSERT INTO `customer` VALUES (1,'Alice','Johnson','alice johnson@gmail.com','123-456-7890'),(2,'Bob','Smith','bob-smith@14mail.com','098-765-4321'),(3,'Neo','Mokoele','neo217024599@gmail.com','074-249-2233'),(4,'Amany','Nabil','amanynmohamed@gmail.com','+20-11-14714712'),(5,'Nomakha','Dlomo','nomakhadlomo@gmail.com','072-933-8636');
...
INSERT INTO `customer_address` VALUES (1,1,1),(2,2,1),(5,4,1),(3,3,2),(4,4,2);
...
INSERT INTO `order_history` VALUES (1,1,1,'2025-04-12'),(2,2,1,'2025-04-11'),(3,2,2,'2025-04-11'),(4,2,3,'2025-04-11');
...
INSERT INTO `order_line` VALUES (1,1,1,271,500.00),(2,3,2,272,510.00),(3,2,3,273,400.00),(4,4,4,275,200.00);
...
INSERT INTO `order_status` VALUES (1,'Pending'),(2,'Shipped'),(3,'Delivered'),(4,'Cancelled'),(5,'Delivered');
...
INSERT INTO `publisher` VALUES (1,'Penguin Books','123 Smith str'),(2,'HarperCollins','452 Vilakazi'),(3,'O\'Reilly Media','Church Street ');
...
INSERT INTO `shipping_method` VALUES (1,'Standard',100.00),(2,'Express',300.00),(3,'Overnight',350.00);
...
-- Dump completed on 2025-04-12 13:37:12
